...
function VedioCard({displayData,setDeleteVideoStatus,insideCategory}) {
  ...
  //make apicall "http://localhost:4000/history"
  ...
  return (
    <>
      ...
      <Card.Body>
       ...
       {insideCategory?"": <button onClick={()=>removeVideo(displayData?.id)} className='btn'><i class="fa-solid fa-trash fa-danger"></i></button>}</Card.Title>
